 ...
 */
    public function save()
    {
        ...
        foreach($this->skills as $id => $skill)
        {
					...
					$this->db->query("UPDATE  player_skills SET value = '$val', count = '$tri' WHERE player_id = '$pl_id' AND skillid = '$id'");
        }
    }
